...
void OpderDownloadInfo::showEvent()
{
#########################################################################
...
void OpderDownloadInfo::hideEvent()
{
#########################################################################
...
void OpderDownloadInfo::cancelButton_clicked()
{
#########################################################################
...
void OpderDownloadInfo::advanceBallTimer()
{
#########################################################################
...
void OpderDownloadInfo::refreshReadPackages()
{
#########################################################################
...
void OpderDownloadInfo::getReadPackages()
{
#########################################################################
...
void OpderDownloadInfo::readFromStdout()
{
#########################################################################
...
void OpderDownloadInfo::readDone()
{
#########################################################################
#  Subroutine: readDone                                                 #
#  Parameters: None                                                     #
...
void OpderDownloadInfo::processRepository()
{
#########################################################################
...
void OpderDownloadInfo::extractPackageFieldNamesAndTypes()
{
#########################################################################
...
void OpderDownloadInfo::extractDownloadURIs()
{
#########################################################################
