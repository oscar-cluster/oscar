...
void OpderDownloadPackage::init()
{
#########################################################################
#  Subroutine: init                                                     #
#  Parameters: None                                                     #
...
void OpderDownloadPackage::showEvent()
{
#########################################################################
...
void OpderDownloadPackage::hideEvent()
{
#########################################################################
...
void OpderDownloadPackage::cancelButton_clicked()
{
#########################################################################
...
void OpderDownloadPackage::downloadStart()
{
#########################################################################
...
void OpderDownloadPackage::downloadNext()
{
#########################################################################
...
void OpderDownloadPackage::downloadDone()
{
#########################################################################
...
void OpderDownloadPackage::readFromStdout()
{
#########################################################################
...
void OpderDownloadPackage::getPackageTable()
{
#########################################################################
...
void OpderDownloadPackage::updateOda()
{
#########################################################################
