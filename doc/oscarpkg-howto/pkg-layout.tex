% $Id: pkg-layout.tex,v 1.13 2003/10/01 20:36:37 naughtont Exp $
...
available in Section~\ref{sect:configurator}.  Also, a package example
containing input and simple processing scripts is available in
Section~\ref{sect:example-configurator}.
