% -*- latex -*-
%
% $Id: design.tex,v 1.10 2001/08/25 15:51:20 jsquyres Exp $
%
% $COPYRIGHT$
%
...
available functions, and call each script from \file{opkgconfig} based
...
\file{opkgconfig} script itself should be listed in each of the file
lists.
