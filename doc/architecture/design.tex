% -*- latex -*-
%
% $Id: design.tex,v 1.9 2001/08/21 19:12:44 geiselha Exp $
%
% $COPYRIGHT$
%
...
\item The \odrkey{CLUSTER} key is a cross reference to the \odrkey{NAME} key
  in the \odrcat{client} category.
