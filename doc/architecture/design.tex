% -*- latex -*-
%
% $Id: design.tex,v 1.5 2001/08/16 14:32:55 mjbrim Exp $
%
% $COPYRIGHT$
%
...
\odrcat{cluster}, \odrcat{group}, \odrcat{hostlist}, and 
\odrcat{packagelist}. Within each category, there are a number of keys 
