% -*- latex -*-
%
% $Id: design.tex,v 1.1 2001/08/14 22:27:59 jsquyres Exp $
%
% $COPYRIGHT$
%
...
\hline
\end{tabular}
\caption{Keys maintained for the \odrcat{adapter} ODR cateogry.}
...
\hline
\end{tabular}
\caption{Keys maintained for the \odrcat{client} ODR cateogry.}
...
\hline
\end{tabular}
\caption{Keys maintained for the \odrcat{cluster} ODR cateogry.}
...
\hline
\end{tabular}
\caption{Keys maintained for the \odrcat{group} ODR cateogry.}
...
\hline
\end{tabular}
\caption{Keys maintained for the \odrcat{packagelist} ODR cateogry.}
...
\hline
\end{tabular}
\caption{Keys maintained for the \odrcat{hostlist} ODR cateogry.}
...
\cmd{pkgconfig \{-c|-s\} <function> [--atboot]}
...
\begin{itemize}
\item \cmd{<pkgname>/pkgconfig}
\item \cmd{<pkgname>/install.files}
\item \cmd{<pkgname>/uninstall.files}
\item \cmd{<pkgname>/configure.files}
\end{itemize}
