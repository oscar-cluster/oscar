% -*- latex -*-
%
% $Id: design.tex,v 1.2 2001/08/14 23:24:03 jsquyres Exp $
%
% $COPYRIGHT$
%
...
\begin{discuss}
  Using a different name than \cmd{pkgconfig} might be good here; it's
  a bit too similar to the Solaris \cmd{pkg} suite of commands.
\end{discuss}
