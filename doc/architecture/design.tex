% -*- latex -*-
%
% $Id: design.tex,v 1.29 2002/10/29 18:05:51 brechin Exp $
%
% $COPYRIGHT$
%
...
\item \xmltag{provide}: A top-level tag effectively indicating
  synonyms for the package name for use during the dependency
  analysis.  There may be zero or more \xmltag{provide} 
...
\item \xmltag{require}: A top-level tag effectively indicating
  dependencies for this OSCAR package.  
  
  Optional/Multi.  If not supplied, no dependencies for this package
  will be used in the dependency analysis.  Multiple \xmltag{require}
