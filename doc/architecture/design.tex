% -*- latex -*-
%
% $Id: design.tex,v 1.14 2002/06/20 04:39:23 jsquyres Exp $
%
% $COPYRIGHT$
%
...
% See Section~\ref{sec:design-wizard}.
...
% (see Section~\ref{sec:design-wizard})
the packages in this directory will be scanned and listed as optional
