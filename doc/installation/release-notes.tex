% -*- latex -*-
%
% $Id: release-notes.tex,v 1.24 2002/11/16 03:53:11 bligneri Exp $
%
% $COPYRIGHT$
%
...
\item Before any OSCAR installation, you should install the following perl packages
\begin{verbatim}
urpmi perl-XML-Simple
perl-XML-Parser
\end{verbatim}

\item Problem with the TCL libraries (rpm not compiled on Mandrake). In order
to avoid an error, make the following symlink~:
\begin{verbatim}
