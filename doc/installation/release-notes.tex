...
%
% $Id: release-notes.tex,v 1.26 2002/11/17 04:02:39 jsquyres Exp $
%
...
\item To avoid problems with the \file{modules} RPM, the following sym
  link must be created {\em before} running the OSCAR installer:

\begin{verbatim}
  # ln -s /usr/lib/libtcl8.3.so /usr/lib/libtcl.so.0
\end{verbatim}

\item ODA is not currently supported on Mandrake.
