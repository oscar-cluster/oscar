% -*- latex -*-
%
% $Id: release-notes.tex,v 1.18 2002/09/06 09:26:24 naughtont Exp $
%
% $COPYRIGHT$
%
...
% TJN: Still need to uncomment the call in 'server_prep', so
%      this comment will be in sync w/ the code. (waiting on lvl=9)
\item The default for {\tt root}'s shell configuration files hardcode
  ...
  \file{/root/.bashrc, /root/.cshrc, /root/.tcshrc}. 
