...
\item On Red Hat Enterprise Linux 4.2 (RHEL4) and CentOS 4.2 systems you 
...
\begin{itemize}
\item Under Fedora Core 4, The below output may be ignored during 
...
\begin{itemize}
\item On Fedora Core 2, The below output  may be ignored during Step~8,
