...
\item While Mandrakelinux 10.0 supports 2.4 kernel, OSCAR only supports
2.6 kernel - this is explicitly specified in \file{oscarsamples/mandrake-10.0-i386.rpmlist}.
