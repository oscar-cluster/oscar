...
%
% $Id: release-notes.tex,v 1.33 2003/02/27 20:58:52 jsquyres Exp $
%
...
IA64 support was removed for the 2.2 release of OSCAR due to timing
problems during the release process.  IA64 support is fully expected
to return in the next release.

\newcommand\donotdisplay[1]{}

\donotdisplay{

\begin{itemize}

% TJN: pretty sure things swapped w/ 2.2 Itanium1 out Itanium2 is in
\begchange
\item Itanium2 is supported on RedHat 7.2, but with 
  version \oscarversion\ Itanium is not supported.
  \footnote{The solution is for the user to compile
...
% TJN: should this just refer to kernel_picker and be done w/ it?
