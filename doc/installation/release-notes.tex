...
%
% $Id: release-notes.tex,v 1.41 2003/11/26 03:05:02 bernardli Exp $
%
...
\end{verbatim}
  ...
  disable X forwarding by passing ssh the \cmd{-x} option, i.e.:
...
\item During the \button{Install/Uninstall Package} step, if you hit the cancel
  button, the post* scripts will still run.  This is normal and should not really
