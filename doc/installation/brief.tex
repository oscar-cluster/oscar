% -*- latex -*-
%
% $Id: brief.tex,v 1.3 2001/12/18 22:48:51 mchasal Exp $
%
% $COPYRIGHT$
%
...
(e.g., \file{eth1})
for your server's private network ethernet adapter. After \file{install\_cluster}
