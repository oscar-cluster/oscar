...
%
% $Id: detailed.tex,v 1.57 2003/02/25 13:50:19 jsquyres Exp $
%
% $COPYRIGHT$
%
...
\detailed{
  ...
  \begin{figure}[htbp]
    \begin{center}
      % JMS Need this one with right net numbers and domainname
...
\item The \button{Dynamic DHCP Update} checkbox at the bottom right of
  ...
  time a MAC is assigned to a node.  If it is off, you will need to
  click the \button{Configure DHCP Server} (at least once) to give it
  the associations between MACs and IP addresses.
