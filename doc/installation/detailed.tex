% -*- latex -*-
%
% $Id: detailed.tex,v 1.18 2002/01/22 20:52:43 mchasal Exp $
%
% $COPYRIGHT$
%
...
\file{oscar-\oscarversion.tgz}.  The version used in these
...
the OSCAR tarball to a directory such as \file{/root} on \endchange
...
\file{/root}, \endchange open a command terminal and issue the
