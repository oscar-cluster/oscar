% -*- latex -*-
%
% $Id: detailed.tex,v 1.37 2002/07/20 15:11:18 jsquyres Exp $
%
% $COPYRIGHT$
%
...
applications include \cmd{neat}, \cmd{netcfg}, or a text editor.
...
\paragraph{Public adaptor.}  This is the adaptor that connects the
server node to a public network.  Although it is not required to have
such an adaptor, if you do have one, you must configure it as
appropriate for the public network (you may need to consult with your
network administrator).

\paragraph{Private adaptor.}  This is the adaptor connected to
the TCP/IP network with the rest of the cluster nodes.  This adaptor
