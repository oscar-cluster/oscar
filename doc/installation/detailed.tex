...
%
% $Id: detailed.tex,v 1.51 2002/11/29 16:41:19 jsquyres Exp $
%
% $COPYRIGHT$
%
...
\quick{Run the \cmd{install\_\-cluster} script from OSCAR's top-level
  directory, with an arugment specifying your server's private network
...
than 255 clients, you will need to run this step multiple times and
change the starting IP address.  There is no need to close the panel
and return to the main OSCAR menu before executing it again; simply
edit the information and click on the \button{Addclients} button as
