...
\subsection{Monitor Client Installations}
\label{det:si_monitortk}

\optional

During the client installation phase it is possible to click on the 
\button{Monitor Client Installation} button and activate the System Imager
monitor.  This application will display nodes as they request images
from the server machine and track their progress as they install.

  \begin{figure}[htbp]
    \begin{center}
      \includegraphics[scale=\imgscale]{figs/si_monitortk}
      \caption{Monitor Client Installations.}
