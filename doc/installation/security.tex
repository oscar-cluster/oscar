% -*- latex -*-
%
% $Id: security.tex,v 1.4 2002/07/20 17:20:09 jsquyres Exp $
%
% $COPYRIGHT$
%
...
default, OSCAR installs and configures \rpmname{pfilter} on the server
...
By all means, use \cmd{ssh} for network logins.  There are also
modified versions of the venerable \cmd{ftp} programs that allow
