% -*- latex -*-
%
% $Id: intro.tex,v 1.8 2002/07/16 14:39:46 jsquyres Exp $
%
% $COPYRIGHT$
%
...
\begin{discuss}
  This is an entirely new section.  Are the contents correct?  -JMS
\end{discuss}
...
\item 2 network interface cards that support a TCP/IP stack
\item At least two contiguous areas of 2GB free space (for a total of
  4GB free space)
...
\item A network interface card that supports a TCP/IP
  ...
  more information.}
\item Homogeneous hardware across all client nodes
...
as well as telling how to start over with a new OSCAR install.
%
