...
package OSCAR::OCA::OS_Detect::SLED;

use strict;

my $distro = "sles"; # SUSE Linux Enterprise Desktop
my $compat_distro = "suse";
my $pkg = "rpm";
my $detect_package = "sles-release"; # rpm package name containing /etc/os-release
...
sub detect_dir {
    ...
    if (%os_release) {
        return undef if ( $os_release{NAME} ne "SLES"); # Refuse to match "SLED" or "openSUSE Leap"
