% -*- latex -*-
%
% $Id: user.tex,v 1.2 2002/06/14 06:07:19 jsquyres Exp $
%
% $COPYRIGHT$
%
...
\item Use the \cmd{lamhalt} command to take down the LAM RTE.  The
  \cmd{lamhalt} command takes no arguments, and will shut down the LAM
  RTE.
\end{enumerate}
