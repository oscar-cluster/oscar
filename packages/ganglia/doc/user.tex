% -*- latex -*-
%
% $Id: user.tex,v 1.1 2002/06/12 04:10:22 jsquyres Exp $
%
% $COPYRIGHT$
%
...
being developed by Matt Massie $<$(\mailto{massie@cs.berkeley.edu}$>$
and Brent Chun $<$\mailto{bnc@caltech.edu}$>$. For additional
...
Packaged for OSCAR is the \rpmname{ganglia-php-rrd-client} that sets
up the web page display on the head node of the data gathered by the
\rpmname{ganglia-monitor-core}.  This uses rrdtool and the
