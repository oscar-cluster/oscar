% -*- latex -*-
%
% $Id: user.tex,v 1.5 2002/06/15 02:07:45 jenos Exp $
%
% $COPYRIGHT$
%
...
the \file{.ssh} folder in your home directory.  It is not recommended that you
...
\cmd{sync\_users} to the crontab.
\end{itemize}
